...
public class HibernateController {
    ...
    public String editBrand(@PathVariable int idGame, ModelMap model) {
        model.addAttribute("title", TITLE);
        model.addAttribute("action", "Edit");

        CarBrand carBrand = carBrandService.get(idGame);
        model.addAttribute("carBrand", carBrand);
        model.addAttribute("edit", true);
        return "brandForm";
    }

    @RequestMapping(value = {  "/"+INSTRUMENT+"/edit-brand/{idGame}" }, method = RequestMethod.POST)
    ...
    public String saveModel(CarModel carModel) {
        ...
        int idGame = carModel.getIdGame();
        carModel.setCarBrand(carBrandService.get(idGame));
